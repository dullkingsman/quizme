...
public class QuizHistoryFragment extends DraggableFragment {
	ImageButton backButton;

	public QuizHistoryFragment(int contentLayoutId) {
	...
	@Override public void initViews(View fragment) {
		...
		this.backButton = fragment.findViewById(R.id.quiz_history_fragment_back_button);
	}
